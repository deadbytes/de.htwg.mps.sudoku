...
1+2                                               //> res0: Int(3) = 3
  ...
  val p1 = new Point1                             //> p1  : L04_Classes.Point1 = L04_Classes$$anonfun$main$1$Point1$1@1572e449
  p1.x = 3
  p1.y = 4
  ...
  val p2 = new Point2(3, 4)                       //> p2  : L04_Classes.Point2 = L04_Classes$$anonfun$main$1$Point2$1@36ff057f
  // Methods for Classes
  ...
  val p31 = new Point3(3, 4)                      //> p31  : L04_Classes.Point3 = L04_Classes$$anonfun$main$1$Point3$1@1cb8deef
  val p32 = new Point3(7, 2)                      //> p32  : L04_Classes.Point3 = L04_Classes$$anonfun$main$1$Point3$1@2d342ba4
  val p33 = p31.vectorAdd(p32)                    //> p33  : L04_Classes.Point3 = L04_Classes$$anonfun$main$1$Point3$1@3c1d332b
  ...
  p51 + p52 - p53                                 //> res1: L04_Classes.Point5 = Point5(12,4)
  ...
  p61 + p62 - p63                                 //> res2: L04_Classes.Point6 = Point6(12,4)
