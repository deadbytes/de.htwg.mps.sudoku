object L06_Functions {
  ...
  odd(lst)                                        //> res0: List[Int] = List(1, 7, 5, 3, 9)
  ...
  even(lst)                                       //> res1: List[Int] = List(2, 8, 6, 14, 12, 4, 10)
  ...
  filter1(lst, isodd)                             //> res2: List[Int] = List(1, 7, 5, 3, 9)

  filter1(lst, (v: Int) => v % 2 == 0)            //> res3: List[Int] = List(2, 8, 6, 14, 12, 4, 10)
  ...
  filter2(lst, (v: Int) => v % 2 == 0)            //> res4: List[Int] = List(2, 8, 6, 14, 12, 4, 10)
  ...
  val lsts=List("It's","a","far","far","better","thing","I","do","now")
                                                  //> lsts  : List[java.lang.String] = List(It's, a, far, far, better, thing, I, 
                                                  //| do, now)
  
  filter2(lsts,(v:String)=> v.length>3)           //> res6: List[java.lang.String] = List(It's, better, thing)
  
  lsts.filter((v:String)=> v.length>3)            //> res7: List[java.lang.String] = List(It's, better, thing)
  
  lsts.filter(v=>v.length>3)                      //> res8: List[java.lang.String] = List(It's, better, thing)
  
  lsts.filter(_.length>3)                         //> res9: List[java.lang.String] = List(It's, better, thing)
  
  lsts.map(_.toList)                              //> res10: List[List[Char]] = List(List(I, t, ', s), List(a), List(f, a, r), Li
                                                  //| st(f, a, r), List(b, e, t, t, e, r), List(t, h, i, n, g), List(I), List(d, 
                                                  //| o), List(n, o, w))
  lsts.flatMap(_.toList)                          //> res11: List[Char] = List(I, t, ', s, a, f, a, r, f, a, r, b, e, t, t, e, r,
                                                  //|  t, h, i, n, g, I, d, o, n, o, w)
  lsts.sort(_<_)                                  //> res12: List[java.lang.String] = List(I, It's, a, better, do, far, far, now,
                                                  //|  thing)
  
lsts.sort(_>_)                                    //> res13: List[java.lang.String] = List(thing, now, far, far, do, better, a, I
                                                  //| t's, I)

lsts.sort(_.toUpperCase<_.toUpperCase)            //> res14: List[java.lang.String] = List(a, better, do, far, far, I, It's, now,
                                                  //|  thing)

lst.foldLeft(0)(_+_)                              //> res15: Int = 81

val lstw=List("Once","more","unto","the","breach")//> lstw  : List[java.lang.String] = List(Once, more, unto, the, breach)
...
uniqueLetters(lstw)                               //> res17: List[Char] = List(A, B, C, E, H, M, N, O, R, T, U)
}